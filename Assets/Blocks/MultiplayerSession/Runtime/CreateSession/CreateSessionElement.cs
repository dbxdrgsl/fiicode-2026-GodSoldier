...
namespace Blocks.Sessions
{
    ...
    {
        const string k_EnterSessionNamePlaceholder = "Room Name (Optional)";
        const string k_CreateButtonText = "HOST";
        ...
        void UpdateBindings()
        {
            ...
            m_ViewModel = new CreateSessionViewModel(SessionSettings?.sessionType, SessionSettings?.sessionName);

    ...
    public class SoundGameObject
    {
        ...
        private Vector3 GetPosition()
        {
            ...
            else if (m_PositionType == PositionType.ParentTransform)
            {
                ...
                Transform parentTransform = audioTransform.parent;
                return parentTransform != null ? parentTransform.position : audioTransform.position;
            }
        ...
        private void UpdateDistanceCurves()
        {
            ...
            if (m_AudioSource == null || m_SoundDef == null)
            {
                m_CalculateDistance = false;
                return;
            }
            ...
            {
                m_LpfCurveNormalizedResult = 1.0f;
                m_HpfCurveNormalizedResult = 1.0f;
                m_SpatialCurveNormalizedResult = 1.0f;
                return;
            }

...
namespace Blocks.Gameplay.Core
{
    ...
    public class SoundSystem
    {
        ...
        /// <summary>
        /// Updates the active AudioListener transform used for spatial audio calculations.
        /// This can change during scene transitions when the previous listener is destroyed.
        /// </summary>
        /// <param name="listenerTransform">The new listener transform, or null when none exists.</param>

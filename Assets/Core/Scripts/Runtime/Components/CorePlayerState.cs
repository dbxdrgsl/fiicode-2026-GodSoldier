...
namespace Blocks.Gameplay.Core
{
    ...
    public class CorePlayerState : NetworkBehaviour
    {
        ...
        private readonly NetworkVariable<GodSoldierPlayerRole> m_PlayerRole = new NetworkVariable<GodSoldierPlayerRole>(
            GodSoldierPlayerRole.None,
            NetworkVariableReadPermission.Everyone,
            NetworkVariableWritePermission.Owner);
        ...
        /// <summary>
        /// Gets the current God Soldier role.
        /// </summary>
        public GodSoldierPlayerRole PlayerRole => m_PlayerRole.Value;
        ...
        /// <summary>
        /// Event raised when the player's God Soldier role changes.
        /// </summary>
        public event Action<GodSoldierPlayerRole> OnRoleChanged;
        ...
        public override void OnNetworkSpawn()
        {
            ...
            m_PlayerRole.OnValueChanged += HandleRoleChanged;
            ...
            OnRoleChanged?.Invoke(m_PlayerRole.Value);
        }
        ...
        /// <summary>
        /// Sets the God Soldier role for this player.
        /// </summary>
        public void SetPlayerRole(GodSoldierPlayerRole newRole)
        {
            if (IsOwner)
            {
                m_PlayerRole.Value = newRole;
            }
            else
            {
                SetPlayerRoleRpc(newRole);
            }
        }
        ...
        [Rpc(SendTo.Owner)]
        private void SetPlayerRoleRpc(GodSoldierPlayerRole newRole)
        {
            m_PlayerRole.Value = newRole;
        }
        ...
        private void HandleRoleChanged(GodSoldierPlayerRole oldRole, GodSoldierPlayerRole newRole)
        {

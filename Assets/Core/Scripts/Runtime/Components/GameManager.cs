...
namespace Blocks.Gameplay.Core
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        private Coroutine m_SessionFadeCoroutine;
        ...
        private void ClientConnected(ulong clientId)
        {
            ...
            EnterGameplayPresentationIfNeeded();
        ...
        private IEnumerator FadeOutAndDisable()
        {
            ...
            m_SessionFadeCoroutine = null;
        }

        private void HandleActiveSceneChanged(Scene previousScene, Scene nextScene)
        {
            ApplyCursorState(nextScene.name);

            if (IsGameplayScene(nextScene.name))
            {
                StartSessionFadeIfNeeded();
            }
        }

        private void EnterGameplayPresentationIfNeeded()
        {
            string sceneName = SceneManager.GetActiveScene().name;
            ApplyCursorState(sceneName);
        ...
        private void StartSessionFadeIfNeeded()
        {
            if (sessionUI == null || m_SessionFadeCoroutine != null)
            {
                return;
            }

            m_SessionFadeCoroutine = StartCoroutine(FadeOutAndDisable());
        }

        private void ApplyCursorState(string sceneName)
        {
